...
Ha de tenerse en cuenta que en todo momento será necesaria la conexión a internet, ya que la aplicación utiliza llamadas a servicios de terceros y API externas. 
